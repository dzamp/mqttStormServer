 ...
 */
public class PressureBolt_V3 extends HealthBolt_V3<Integer>  {
    ...
    public void emitEmergencyValues(String id, Integer currentValue) {
        if(currentValue > pressure_threshold){
    ...
    @Override
    public void insertDocument(String id, Integer pressureValue, long timestamp) {
