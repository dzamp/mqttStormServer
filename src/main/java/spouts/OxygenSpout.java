 ...
 */
public class OxygenSpout implements IRichSpout, MqttCallback {
...
//            client = new MqttClient("tcp://workstation00.raspberryip.com:1883", "Sending"+ Time.currentTimeMillis()); //persistence error?
            ...
            client.subscribe(OXYGEN_TOPIC, 1);
        ...
        while (!messageQueue.isEmpty()) {
            ...
            try {
                ...
                if (message != null && topic!=null) {
                    ...
                    System.out.println("OXYGEN : Printing values of topic " + topic + " " + values[0] + " " + values[1]+ " " + values[2]);
    ...
    public void declareOutputFields(OutputFieldsDeclarer outputFieldsDeclarer) {
        ...
        // outputFieldsDeclarer.declareStream(OXYGEN_STREAM, new Fields("id", "oxygen_value", "timestamp"));
        //2 old way,
        outputFieldsDeclarer.declare(new Fields("id", "oxygen-value", "timestamp"));
