...
public class HealthMonitorTopologyDemo {
    ...
    static TopologyBuilder prepareHealthMonitorTopology(){
        TopologyBuilder builder = new TopologyBuilder();
        ...
        builder.setBolt(PRESSURE_BOLT, new PressureBoltDemo(), 2).fieldsGrouping(PRESSURE_SPOUT, new Fields("id"));
        builder.setBolt(OXYGEN_BOLT, new OxygenSaturationBoltDemo(), 2).fieldsGrouping(OXYGEN_SPOUT, new Fields("id"));
        builder.setBolt(TEMPERATURE_BOLT, new TemperatureBoltDemo(), 2).fieldsGrouping(TEMPERATURE_SPOUT, new Fields("id"));
        ...
        builder.setBolt(EMERGENCY_BOLT, new EmergencyBoltDemo(), 2).fieldsGrouping(PRESSURE_BOLT, PressureBolt.EMERGENCY_STREAM, new Fields("id"))
                .fieldsGrouping(OXYGEN_BOLT, OxygenSaturationBoltDemo.EMERGENCY_STREAM, new Fields("id"))
                .fieldsGrouping(TEMPERATURE_BOLT, TemperatureBoltDemo.EMERGENCY_STREAM, new Fields("id"));
