...
import timestamp_join.RandomWordSpout;

public class DemoWindowTopology {
...
//        config.put(Config.TOPOLOGY_MAX_SPOUT_PENDING, 1);
        ...
        BaseWindowedBolt windowBolt = new TimeWindowedBolt().withWindow(BaseWindowedBolt.Duration.seconds(30), BaseWindowedBolt.Duration.seconds(10));
